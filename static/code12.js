...
// load the data
d3.json("https://communicationmonitor.cn.ntua.gr:5000/transactionsdepictionoutput", function(error, _graph) {
...
function triplesToGraph(triples){
    ...
    triples.forEach(function(triple){
        var subjId = triple.detail;
        var predId = triple.name;
        var objId = triple.source;
...
function color(d) {
  return d.l=="sub" ? "blue" // collapsed package
      : d.l=="obj" ? "green" // expanded package
      : "red"; // leaf node
}
